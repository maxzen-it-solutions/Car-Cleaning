...
//   return (
//     <div className="w-full overflow-x-hidden flex min-h-screen bg-[#0f0f0f] text-white font-sans">
    ...
    <div className="flex flex-col lg:flex-row min-h-screen bg-[#0f0f0f] text-white font-sans">
      ...
      <main className="flex-1 p-4 sm:p-6 lg:p-8">
        ...
        <div className="bg-[#1a1a1a] p-4 sm:p-6 rounded-xl shadow overflow-x-auto">
          <h2 className="text-lg sm:text-xl font-semibold mb-4">Latest Transactions</h2>
          <table className="w-full text-xs sm:text-sm text-left min-w-[600px]">
            <thead className="text-gray-400 border-b border-gray-600">
              <tr>
                <th className="py-2 px-3 sm:px-4">Purchase ID</th>
                <th className="py-2 px-3 sm:px-4">Buyer Name</th>
                <th className="py-2 px-3 sm:px-4">Invoice</th>
                <th className="py-2 px-3 sm:px-4">Date</th>
                <th className="py-2 px-3 sm:px-4">Amount</th>
                <th className="py-2 px-3 sm:px-4">Method</th>
            ...
            <tbody>
              {[
                ...
                <tr key={idx} className="border-b border-gray-700">
                  <td className="py-2 px-3 sm:px-4">{tx.id}</td>
                  <td className="py-2 px-3 sm:px-4">{tx.name}</td>
                  <td className="py-2 px-3 sm:px-4">{tx.invoice}</td>
                  <td className="py-2 px-3 sm:px-4">{tx.date}</td>
                  <td className="py-2 px-3 sm:px-4">{tx.amount}</td>
                  <td className="py-2 px-3 sm:px-4">{tx.method}</td>
